...
#ifndef FLASH_READOUT_ROW_CAPACITY
#define FLASH_READOUT_ROW_CAPACITY 512U
#endif

extern "C" {
extern volatile uint32_t g_flash_csv_ready;
extern volatile uint32_t g_flash_csv_done;
...
extern volatile uint32_t g_flash_csv_chunk_index;
extern volatile uint32_t g_flash_csv_chunk_records;
extern volatile uint32_t g_flash_csv_total_len;
